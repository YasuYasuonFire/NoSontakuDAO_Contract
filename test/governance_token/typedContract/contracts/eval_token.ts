...
import ABI from '../../artifacts/eval_token.json';
import QueryMethods from '../query/eval_token';
import BuildExtrinsicMethods from '../build-extrinsic/eval_token';
import TxSignAndSendMethods from '../tx-sign-and-send/eval_token';
import MixedMethods from '../mixed-methods/eval_token';
import EventsClass from '../events/eval_token';
