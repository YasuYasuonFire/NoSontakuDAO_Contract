...
export default class Methods {
	...
	*/
	"renounceRole" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "accessControl::renounceRole", [role, account], __options , (result) => { return handleReturnType(result, getTypeDescription(25, 'eval_token')); });
	}
	...
	*/
	"grantRole" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "accessControl::grantRole", [role, account], __options , (result) => { return handleReturnType(result, getTypeDescription(25, 'eval_token')); });
	}
	...
	*/
	"revokeRole" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "accessControl::revokeRole", [role, account], __options , (result) => { return handleReturnType(result, getTypeDescription(25, 'eval_token')); });
	}
