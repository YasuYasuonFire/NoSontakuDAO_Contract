...
import ABI from '../../artifacts/governance_token.json';
import QueryMethods from '../query/governance_token';
import BuildExtrinsicMethods from '../build-extrinsic/governance_token';
import TxSignAndSendMethods from '../tx-sign-and-send/governance_token';
import MixedMethods from '../mixed-methods/governance_token';
import EventsClass from '../events/governance_token';
