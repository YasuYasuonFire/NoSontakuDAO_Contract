...
import ABI from '../../artifacts/governor.json';
import QueryMethods from '../query/governor';
import BuildExtrinsicMethods from '../build-extrinsic/governor';
import TxSignAndSendMethods from '../tx-sign-and-send/governor';
import MixedMethods from '../mixed-methods/governor';
import EventsClass from '../events/governor';
